      ...
      {(data, lastRefreshed) => {
        ...
        return (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
              ...
              <div className="animate-fade-in-up opacity-0 delay-400 bg-white rounded-2xl shadow-lg shadow-gray-200/50 p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Total Drinks Cost</span>
                </div>
                <p className="text-2xl font-bold text-gray-800">
            ...
            {/* Daily Drinks Cost Table */}
            <div className="animate-fade-in-up opacity-0 delay-300 mb-6">
              <DailyDrinksCostTable rows={rows} totals={totals} />
            </div>

            {/* Drinks Purchases Table */}
            <div className="animate-fade-in-up opacity-0 delay-400">
              <DrinksPurchaseTable rows={drinksPurchases} />
            </div>
          </>
        );
      }}
